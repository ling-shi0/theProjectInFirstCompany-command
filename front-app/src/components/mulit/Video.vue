...
<template>
  <div class="player">
    ...
    <!-- <video-player
      ...
      @click="fullScreen"
    /> -->
    <div class="magnify" @click="magnify"></div>
  </div>
</template>
<script>
import Vue from "vue";
...
export default {
    ...
    videoInfo: {
      handler() {
        ...
        this.videoSrc =
          ...
          "/avc-app/service/rs/v1/api/alert/videoPreview?url=" +
          window.btoa(this.videoInfo.url);
        this.videoType = this.videoInfo.type;
  ...
  methods: {
    ...
    magnify() {
      ...
      //   this.height = document.documentElement.clientWidth * 2;
      //   // this.newKey = +new Date();
      // }
    },
  },
